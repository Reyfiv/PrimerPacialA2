<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cDepositos.aspx.cs" Inherits="PrimerPacialA2.Consultas.cDepositos" %>
            ...
            <AlternatingRowStyle BackColor="White" />
                <Columns>
                    <asp:HyperLinkField ControlStyle-ForeColor="Black"
                        ...
                        DataNavigateUrlFormatString="/Registros/rDepositos.aspx?Id={0}"
                        Text="Editar">
                    </asp:HyperLinkField>
                </Columns>
